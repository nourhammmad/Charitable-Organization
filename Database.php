...
class Database {
    ...
    public function __construct() {
        $this->connect();  // Initialize the connection when the instance is created
    }
    ...
    public function getConnection(): mysqli {
        if (self::$conn === null) {
            $this->connect(); // Optional reconnect attempt
        }
        return self::$conn;
    }
...
//         self::$conn = new mysqli(DB_HOST, DB_USER, DB_PASS, DB_NAME, DB_PORT);
//         if (self::$conn->connect_error) {
//             die("Connection failed: " . self::$conn->connect_error); // You can log this error instead of dying
//         }
//     }
